...
import com.sirkaue.med.voll.api.domain.medico.Especialidade;
...
class ConsultaControllerTest {
    ...
    @Test
    @DisplayName("Deveria delvover código http 404 quando informações estão inválidas")
    @WithMockUser
    ...
    @Test
    @DisplayName("Deveria delvover código http 200 quando informações estão válidas")
    @WithMockUser
